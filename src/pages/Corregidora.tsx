...
const Corregidora = () => {
  ...
  // Inicializar Meta Pixel específico para Corregidora (Soledad)
  useEffect(() => {
    // Cargar el script de Facebook Pixel si no existe
    if (!document.getElementById('fb-pixel-corregidora')) {
      const script = document.createElement('script');
      script.id = 'fb-pixel-corregidora';
      script.innerHTML = `
